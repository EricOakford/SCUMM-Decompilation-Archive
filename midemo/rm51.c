...
[0044] (0F) if (getState(304) == 1) {
[004A] (10)   VAR_RESULT = getObjectOwner(306);
[004F] (48)   if (VAR_RESULT == 15) {
[0056] (1D)     if (classOfIs(306,[6])) {
[005F] (50)       pickupObject(306);
[0062] (18)     } else {
[0065] (D8)       printEgo([Text("I think that bird will peck my hand off.")]);
[0090] (**)     }
[0090] (**)   }
[0090] (18) } else {
[0093] (D8)   printEgo([Text("It'd be easier if the door was open.")]);
[00BA] (**) }
[00BA] (00) stopObjectCode();
[00BB] (90) VAR_RESULT = getObjectOwner(VAR_ME);
[00C0] (88) if (VAR_RESULT != VAR_EGO) {
[00C7] (0F)   if (getState(304) == 0) {
[00CD] (D8)     printEgo([Text("I can't see through the door.")]);
[00ED] (18)   } else {
[00F0] (D8)     printEgo([Text("I think it's a red herring.")]);
[010E] (**)   }
[010E] (18) } else {
[0111] (D8)   printEgo([Text("I think it's a red herring.")]);
[012F] (**) }
[012F] (00) stopObjectCode();
[0130] (10) VAR_RESULT = getObjectOwner(306);
[0135] (C8) if (VAR_RESULT == VAR_EGO) {
[013C] (48)   if (Local[0] == 343) {
[0143] (D8)     printEgo([Text("I don't like fish soup.")]);
[015D] (48)   } else if (Local[0] == 303) {
[0167] (D8)     printEgo([Text("Yuck!  The pot isn't clean." + wait() + "I think I'll just hold onto this fish.")]);
[01AD] (18)   } else {
[01B0] (0A)     startScript(3,[]);
[01B3] (**)   }
[01B3] (18) } else {
[01B6] (D8)   printEgo([Text("I'd better pick the fish up first.")]);
[01DB] (**) }
[01DB] (00) stopObjectCode();
[01DC] (79) doSentence(3,Local[0],VAR_ME);
[01E2] (00) stopObjectCode();
END
...
[0095] (29)   setOwnerOf(308,14);
[0099] (80)   breakHere();
[009A] (80)   breakHere();
[009B] (54)   setObjectName(343,"hunk o' meat soup");
[00B0] (91)   animateCostume(VAR_EGO,3);
[00B4] (D8)   printEgo([Text("This will take a while to cook.")]);
[00D6] (18) } else {
[00D9] (0A)   startScript(3,[]);
[00DC] (**) }
[00DC] (00) stopObjectCode();
[00DD] (10) VAR_RESULT = getObjectOwner(308);
[00E2] (48) if (VAR_RESULT == 15) {
[00E9] (1A)   Var[171] = 9;
[00EE] (18) } else {
[00F1] (1A)   Var[171] = 8;
[00F6] (**) }
[00F6] (00) stopObjectCode();
END
