...
[0013] (**) }
[0013] (AC) Exprmode Var[155] = ((373 - 361) / 3);
[0022] (0A) startScript(200,[]);
[0025] (2A) startScript(201,[],F);
[0028] (80) breakHere();
[0029] (D2) actorFollowCamera(VAR_EGO);
...
[0022] (2A) startScript(204,[],F);
[0025] (2A) startScript(202,[],F);
...
[0030] (D8)   printEgo([Text("I'll just take what I need." + wait() + "I'm not a pirate^")]);
[0061] (91)   animateCostume(VAR_EGO,250);
[0065] (AE)   WaitForMessage();
[0067] (D8)   printEgo([Text("^yet.")]);
[006F] (AE)   WaitForMessage();
[0071] (18) } else {
[0074] (91)   animateCostume(VAR_EGO,250);
[0078] (D8)   printEgo([Text("I don't need any more mints." + wait() + "At least I don't think I do^")]);
...
[0024] (6A)     startScript(206,[Local[0]],F,R);
[002A] (18)   } else {
[002D] (6A)     startScript(205,[Local[0]],F,R);
[0033] (**)   }
...
[0024] (1A) Var[171] = 13;
[0029] (00) stopObjectCode();
[002A] (D8) printEgo([Text("If this was the real Monkey Island\x0F game, he'd probably want to talk for hours." + wait() + "But this is only a demo^" + wait() + "^so I'll leave him alone for now.")]);
...
[0051] (0A) startScript(96,[]);
[0054] (00) stopObjectCode();
[0055] (0A) startScript(13,[VAR_ME,Local[0],VAR_EGO,143]);
