...
[0038] (1E)   walkActorTo(12,24,48);
[003C] (48)   if (Var[132] == 0) {
[0042] (1A)     Var[132] = 1;
[0046] (42)     startScript(144);
[0048] (**)   }
[0048] (18) } else {
[004B] (D8)   printEgo("The handle's missing.");
[0060] (**) }
[0060] (00) stopObjectCode();
[0061] (8F) if (!getState08(VAR_ACTIVE_OBJECT1)) {
[0065] (3C)   stopSound(18);
[0067] (47)   clearState08(233);
[006A] (57)   setState02(233);
[006D] (**) }
[006D] (00) stopObjectCode();
[006E] (48) if (VAR_ACTIVE_OBJECT2 == 153) {
[0074] (C7)   clearState08(VAR_ACTIVE_OBJECT1);
[0076] (29)   setOwnerOf(153,0);
[007A] (18) } else {
[007D] (D8)   printEgo("That doesn't make sense.");
[0094] (**) }
...
Events:
   ...
   2 - 0025
   B - 002D
[001D] (19) doSentence(1,114,0,0);
[0024] (00) stopObjectCode();
[0025] (19) doSentence(2,114,0,0);
[002C] (00) stopObjectCode();
[002D] (91) animateActor(VAR_EGO,250);
[0030] (D8) printEgo("I'd like a little more privacy for that!");
